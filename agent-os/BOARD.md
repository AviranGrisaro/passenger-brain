...
| PAS-7 | Scope Scenic Walk weighted-routing + TikTok import feasibility | in-progress | data-engineer | 2026-07-30 | Founders-meeting 2026-07-30 lock. Two feasibility asks, same risk class as PAS-5: (1) Scenic Walk's per-street-segment "Attractiveness" weighted routing — a real scope increase over the 2026-07-29 polyline-comparison-only lock; (2) TikTok video → place-extraction ingestion pipeline, brand new V1 feature. Dispatched to `data-engineer`, in flight. |
