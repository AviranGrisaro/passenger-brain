...
If a *fact* can be found by exploring the environment (the `locali-brain/` repo, the glossary/CONTEXT, the codebase, tools), look it up rather than asking. The *decisions*, though, are the user's — put each one to them and wait for their answer.
