...
After scoring, check `content/10-outputs/meeting-notes/` and previous feedback files for the same recurring meeting. If previous feedback exists, show a trend:
...
Save feedback files with consistent naming: `content/10-outputs/meeting-notes/feedback-[meeting-name]-[date].md` to enable trend tracking.
...
**Source:** `content/10-outputs/decisions/` if this meeting made a decision
...
**Source:** `content/01-discovery/stakeholders.md`
