...
|--------|---------------|--------------|-----------------|
| Current PRD | `content/prds/*.md` | feature name from chat | Hypothesis, problem statement, user impact |
| Business Info | `content/01-discovery/business-info.md` | business model, growth stage, metrics | Product strategy, current North Star |
| Metrics Context | `content/07-analytics/*.md` | baseline numbers, historical data | Current metric baselines, ranges |
| Strategy | `content/strategy/*.md` | feature related to strategic pillar | Strategic fit and expected outcomes |
| Meetings | `content/10-outputs/meeting-notes/*.md` | feature name, "success metrics" | Stakeholder expectations, past decisions |
...
**Checking:**
- `content/prds/` for any existing PRD for this feature
- `content/01-discovery/business-info.md` for your product model
- `content/07-analytics/` for historical baseline data
- `content/strategy/` for strategic context
- `content/10-outputs/meeting-notes/` for stakeholder expectations
...
- Archive: Store final metrics in `content/07-analytics/[feature-name]-baseline.md` for historical reference
...
- `content/01-discovery/business-info.md` - Company metrics and baselines
...
- [ ] **File saved to correct location:** Output saved to `content/10-outputs/analyses/feature-metrics-[feature-name]-[date].md`
- [ ] **Context routing table was checked:** Reviewed `content/prds/` for feature context, `content/01-discovery/business-info.md` for North Star metric, and `content/07-analytics/` for existing dashboards and baselines
...
- [ ] **Metrics ladder to North Star:** The output explicitly shows how the primary metric connects upward to the company's North Star metric from `content/01-discovery/business-info.md`
