...
|--------|---------------|--------------|-----------------|
| Business Info | `content/01-discovery/business-info.md` | company, product, team | Company context for interpreting discussions |
| Stakeholder Profiles | `content/01-discovery/stakeholders.md` | attendees' names | Communication preferences, roles, decision authority |
| Active PRDs | `content/prds/*.md` | features discussed | Link action items to active PRDs |
| Previous Meetings | `content/10-outputs/meeting-notes/*.md`, `content/10-outputs/meeting-notes/` | same meeting name, same attendees | Carry-over items, open questions from last time |
| Strategy | `content/strategy/*.md` | strategic pillars, OKRs | Align decisions to strategic context |
| Decisions | `content/10-outputs/decisions/*.md` | related decisions | Check for conflicts with past decisions |
...
5. **Strategic alignment is noted for each decision** -- tie decisions to strategic pillars from `content/strategy/` when relevant
...
- [ ] **File saved correctly** -- output saved to `content/10-outputs/meeting-notes/cleanup-[date].md`
