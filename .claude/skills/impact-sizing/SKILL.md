...
|--------|---------------|--------------|-----------------|
| Current PRD | `content/prds/*.md` | feature name from chat | User impact, problem severity |
| User Research | `content/11-competitors/*.md` | feature problem, user quotes | Addressable users, pain severity |
| Business Model | `content/01-discovery/business-info.md` | pricing, revenue model, TAM | Revenue impact drivers |
| Historical Data | `content/07-analytics/*.md` | similar features, baseline conversion | Reference adoption rates |
| Strategy | `content/strategy/*.md` | feature strategic fit | Resource availability, priority context |
...
**Checking:**
- `content/prds/` for the feature definition
- `content/11-competitors/` for user research on this problem
- `content/01-discovery/business-info.md` for business model context
- `content/07-analytics/` for comparable feature data
...
- Active work: `content/10-outputs/analyses/impact-sizing-[feature-name]-[date].md`
- When finalized: Reference in PRD in `Strategic Fit` section
- Archive: Move to `content/prds/` as historical reference when feature ships
...
**Pulls from:**
- `content/11-competitors/` - User pain and adoption patterns
- `/user-research-synthesis` - Qualitative insights about addressable users
- `content/01-discovery/business-info.md` - Business model and growth drivers
- `content/07-analytics/` - Historical data on similar features
...
- [ ] **File saved to correct location:** Output saved to `content/10-outputs/analyses/impact-sizing-[feature-name]-[date].md`
- [ ] **Context routing table was checked:** Reviewed `content/01-discovery/business-info.md`, `content/strategy/`, and `content/07-analytics/` for relevant context
...
- [ ] **Impact tied to strategic goal:** The recommendation section explicitly references a strategic goal or OKR from `content/strategy/`
