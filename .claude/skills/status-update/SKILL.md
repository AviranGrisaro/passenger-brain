...
|--------|---------------|--------------|-----------------|
| Recent PRDs | `content/prds/*.md` | feature being updated | Feature status and changes |
| Meeting Notes | `content/10-outputs/meeting-notes/*.md` | this week's meetings | Decisions, action items, blockers |
| Action Items | `content/10-outputs/meeting-notes/` | completed / in progress / blocked | Track completion of commitments |
| Strategy | `content/strategy/*.md` | strategic pillars | Tie accomplishments to strategy |
| Metrics | `content/07-analytics/*.md` | baseline, trends | Metric movement and progress |
...
**Checking:**
- `content/10-outputs/meeting-notes/` for recent meetings this week/period
- `content/prds/` for features you're working on
- `content/07-analytics/` for recent metric changes
...
**Status updates:**
- Weekly/recurring: Save to `content/10-outputs/status-updates/[date]-[audience].md`
- Archive: Move finalized updates to `content/10-outputs/meeting-notes/status-updates/` for historical record
...
- `content/strategy/` - Strategic context and goals
