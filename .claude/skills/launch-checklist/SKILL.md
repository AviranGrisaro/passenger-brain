...
**Output:** Saved to `content/10-outputs/launches/[feature-name]-launch-checklist.md`
...
1. `content/prds/` or `content/prds/` - PRD for feature details
2. `content/10-outputs/launches/` - Past launch checklists (learn from history)
3. `content/strategy/` - GTM approach, stakeholders
4. `content/01-discovery/stakeholder-*.md` - Who needs to be involved
...
Create file: `content/10-outputs/launches/[feature-name]-launch-checklist.md`
