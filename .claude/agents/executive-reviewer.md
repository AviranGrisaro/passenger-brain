...
Replace the old "Ship It / Needs Work / Don't Build / Needs More Data" verdict with per-dimension 0-10 scores PLUS the verdict. For every score below 10, **state what a 10 would look like for THIS feature** — specific to Passenger's strategy, not generic.

### The five dimensions

| # | Dimension | What 10 looks like (generic — adapt to Passenger) |
|---|---|---|
