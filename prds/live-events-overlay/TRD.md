...
- **`data-engineer`** on §4.2's query amendment (D1) — it changes no SQL and adds no build step, but it edits a client request `live-events-pipeline/TRD.md` §4.2 documented, and that TRD is already approved.
