...
**Task:** T-032 · **Linear:** `PAS-15` (§9 amendments carried at `PAS-51`; v6 re-scope at `T-077`/`PAS-51`) · **Status:** v6 — §9 amendment + one new build step (C16), no `trd-review` re-run owed
**Owner:** architect · **Date:** 2026-07-30 · **Revised:** 2026-08-07 (v6)
