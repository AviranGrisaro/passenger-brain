...
**Task:** T-037 · **Linear:** `PAS-28` · **Status:** v2 — **amended 2026-08-04 by `product`, D6 only** (T-048/`PAS-35`: the Local threshold is confirmed at 2, decision #45). No architectural change: §1 row 3, §4.2, D6, §11's risk row and §12's routing lines are updated to stop describing a decided number as provisional. Everything else is `architect`'s v1, untouched.
**Owner:** architect · **Date:** 2026-08-03 (v1) · 2026-08-04 (v2 amendment, `product`)
**PRD:** [`passport.md`](./passport.md) (Draft v2)
